      ...
      <div className="flex w-3/4 min-h-full rounded-3xl shadow-lg m-auto bg-gray-100">
       ...
       <div className='form-container'>
         ...
         <div className='flex flex-col items-center justify-center h-full '>
           <h1 className='text-white text-2xl'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Est tempore ea unde. Quo placeat error aperiam minus </h1>
           <hr className='h-1 bg-white w-1/4 rounded-full my-5' />
           <form noValidate onSubmit={handleSubmit} className='flex justify-center w-full '>
             <input
             type='text'
             className='relative rounded-xl py-2 py-3 w-2/3 bg-gray-300 bg-opacity-60 text-white placeholder-gray-200'
             onChange={handleChange}
             required />
             <button type='submit' className='z-10'>
               <i className='fa fa-search text-white ml-10 border-1 my-auto z-10 cursor-pointer p-3' aria-hidden='true' onClick={() => {
